...
/* harmony import */ var _update_employee_update_employee_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./update-employee/update-employee.component */ "./src/app/update-employee/update-employee.component.ts");
...
const routes = [{
    ...
    {
        path: "home", component: _home_home_component__WEBPACK_IMPORTED_MODULE_7__["HomeComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
    },
    {
    ...
    {
        path: "updateEmployee", component: _update_employee_update_employee_component__WEBPACK_IMPORTED_MODULE_11__["UpdateEmployeeComponent"]
    },
    {
...
/* harmony import */ var _add_employee_add_employee_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./add-employee/add-employee.component */ "./src/app/add-employee/add-employee.component.ts");
...
/* harmony import */ var _update_employee_update_employee_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./update-employee/update-employee.component */ "./src/app/update-employee/update-employee.component.ts");
...
/* harmony import */ var _shared_material_module__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./shared/material.module */ "./src/app/shared/material.module.ts");
/* harmony import */ var _shared_mat_confirm_dialog_mat_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./shared/mat-confirm-dialog/mat-confirm-dialog.component */ "./src/app/shared/mat-confirm-dialog/mat-confirm-dialog.component.ts");
...
/* harmony import */ var _ngx_loading_bar_router__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! @ngx-loading-bar/router */ "./node_modules/@ngx-loading-bar/router/fesm2015/ngx-loading-bar-router.js");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _add_employee_add_employee_component__WEBPACK_IMPORTED_MODULE_13__["AddEmployeeComponent"],
            ...
            _update_employee_update_employee_component__WEBPACK_IMPORTED_MODULE_18__["UpdateEmployeeComponent"],
        ...
        imports: [
            ...
            _shared_material_module__WEBPACK_IMPORTED_MODULE_21__["MaterialModule"],
...
let EmployeeDetailsComponent = class EmployeeDetailsComponent {
    ...
    getEmployee(id) {
        this.service.getSelectedEmployee(id)
            .subscribe((response) => {
            console.log(response);
...
/* harmony import */ var _ngx_loading_bar_core__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @ngx-loading-bar/core */ "./node_modules/@ngx-loading-bar/core/fesm2015/ngx-loading-bar-core.js");
...
let HomeComponent = class HomeComponent {
    constructor(route, service, dialogService, toastr, loading) {
        this.route = route;
        this.service = service;
...
let HttpServiceService = class HttpServiceService {
    ...
    RegisterUser(obj) {
        return (this.http.post(`${this.baseUrl}register`, obj, { responseType: 'text' }));
    }
    addEmployee(empObj) {
        return (this.http.post(`${this.baseUrl}addEmployee`, empObj, { responseType: 'text' }));
    }
    getAllCountry() {
    ...
    getSelectedEmployee(id) {
        return (this.http.get(`${this.baseUrl}getSelectedEmployee/${id}`));
    }
    updateEmployee(obj) {
...
module.exports = __webpack_require__(/*! D:\jbk\Frontend\Angular\angularProject\src\main.ts */"./src/main.ts");
